# Reference: https://github.com/warmspringwinds/pytorch-segmentation-detection/blob/master/pytorch_segmentation_detection/datasets/pascal_voc.py
...
class PascalVOCSegmentation(data.Dataset):
    ...
    def __init__(self,
        ...
        if root is None:
            ...
            root = os.path.expanduser(
                '~/.pytorch-segmentation-detection/datasets/pascal_voc_segmentation'
            )
    ...
    def _download_dataset(self):
        ...
        if os.path.isfile(self.pascal_tar_full_download_filename):
            ...
            urllib.request.urlretrieve(self.PASCAL_URL,
                                       self.pascal_tar_full_download_filename,
                                       _progress)
        ...
        if os.path.isfile(self.berkeley_tar_full_download_filename):
            ...
            print(
                "\n Downloading Berkeley segmentation additional dataset to {}"
                .format(self.berkeley_tar_full_download_filename))
            urllib.request.urlretrieve(
                self.BERKELEY_URL, self.berkeley_tar_full_download_filename,
                _progress)
